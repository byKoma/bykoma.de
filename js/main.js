document.addEventListener('DOMContentLoaded', function() {
    ...
    const revealOnScroll = function() {
        const elementsToReveal = document.querySelectorAll('.section-header, .about-content, .skill-item, .project-item, .contact-content, .social-icons, .hero-content h1, .hero-content p, .hero-buttons');
